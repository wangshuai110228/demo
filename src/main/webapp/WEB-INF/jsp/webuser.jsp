...
<script>
    ...
    function add(){
        $("#myForm").form("submit",{
            url:"<%=request.getContextPath() %>/web/addWebUser",
            success:function(){
    ...
    function openUpdateBy(id){
        //alert(id)
        $.ajax({
            url:"<%=request.getContextPath() %>/web/queryWebUserById",
            type:"post",
            data:{"id":id},
    ...
    function deleteByid(id){
        ...
        $.messager.confirm("提示","是否确定删除!",function(r){
            if(r){
                $.ajax({
                    url:"<%=request.getContextPath() %>/web/deleteWebUserAll",
                    type:"post",
                    data:{"id":id},
                    success:function(){
    ...
    //查询
    $("#myTable").datagrid({
        url:"<%=request.getContextPath()%>/web/queryWebUser",
        columns:[[
