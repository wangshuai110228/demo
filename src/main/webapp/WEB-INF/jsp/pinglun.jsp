...
<script>
    ...
    function add(){
        $("#myForm").form("submit",{
            url:"<%=request.getContextPath() %>/comment/addEvaluate",
            success:function(){
    ...
    function openUpdateBy(id){
        $.ajax({
            url:"<%=request.getContextPath() %>/comment/queryEvaluateById",
            type:"post",
            data:{"id":id},
    ...
    function deleteByid(id){
        ...
        $.messager.confirm("提示","是否确定删除!",function(r){
            if(r){
                $.ajax({
                    url:"<%=request.getContextPath() %>/comment/deleteAll",
                    type:"post",
                    data:{"id":id},
                    success:function(){
    ...
    //查询
    $("#myTable").datagrid({
        url:"<%=request.getContextPath()%>/comment/queryPinLun",
        columns:[[
