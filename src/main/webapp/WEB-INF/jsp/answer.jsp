...
<script>
    ...
    function openUpdateBy(id){
        //alert(id)
        $.ajax({
            url:"<%=request.getContextPath() %>/answer/queryAnswerById",
            type:"post",
            data:{"id":id},
    ...
    function add(){
        $("#myForm").form("submit",{
            url:"<%=request.getContextPath() %>/answer/addAnswer",
            success:function(){
    ...
    function deleteByid(id){
        ...
        $.messager.confirm("提示","是否确定删除!",function(r){
            if(r){
                $.ajax({
                    url:"<%=request.getContextPath() %>/answer/deleteAnswerAll",
                    type:"post",
                    data:{"id":id},
                    success:function(){
    ...
    //查询
    $("#myTable").datagrid({
        url:"<%=request.getContextPath()%>/answer/queryAnswer",
        columns:[[
